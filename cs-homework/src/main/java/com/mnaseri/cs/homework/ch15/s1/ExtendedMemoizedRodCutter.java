...
public class ExtendedMemoizedRodCutter {


    private Map<Integer, Integer> price;

    public ExtendedMemoizedRodCutter(Map<Integer, Integer> price) {
    ...
    public static void main(String[] args) {
        ...
        p.put(9, 24);
        p.put(10, 30);
        ExtendedMemoizedRodCutter rodCutter = new ExtendedMemoizedRodCutter(p);
